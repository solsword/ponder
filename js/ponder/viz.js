...
export function draw_histogram(
  element,
  counts,
  ordering,
  bar_limit,
  ...
  var bar_value, bar_label;
  if (typeof normalize === "object") {
    bar_value = function (value) {
