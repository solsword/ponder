...
import * as d3sc from "../node_modules/d3-scale-chromatic/dist/d3-scale-chromatic.js";
import * as utils from "./utils.js";
import * as qt from "./quadtree.js";
import * as ds from "./dataset.js";
import * as prp from "./properties.js";
import * as fl from "./filters.js";
...
export function HelpWidget(text) {
...
export function ColorScaleWidget(
  default_selection,
  default_color,
...
export function SetSelectWidget(label, items, callback) {
  BaseWidget.call(this);
  this.label = label;
...
export function ComparisonFilterControls(dataset, callback, default_index) {
  BaseWidget.call(this);
...
// entire object as an argument after every parameter change.
export function ValueSetFilterControls(dataset, callback, default_index) {
  BaseWidget.call(this);
  if (default_index == undefined) {
    default_index = ds.nth_of_kind(
      dataset,
...
// time.
export function MultiFilterControls(dataset, callback, label) {
  BaseWidget.call(this);
  this.data = dataset;
  if (label == undefined) {
    this.label = "Criteria:";
...
export function View(id, dataset, controls, help) {
  this.id = id;
  this.data = dataset;
...
export function LensView(id, dataset, x_index, y_index) {
  ...
  this.controls.push(
    new ToggleWidget(
      ...
      function (yes) {
        ...
        the_view.update_outlier_handling();
...
LensView.prototype.draw = function() {
  ...
  viz.draw_quadtree(
    ...
    function (v) {
      ...
      if (dom[0] <= v && v <= dom[1]) {
        let grad = the_view.color_widget.get_gradient();
...
LensView.prototype.update_outlier_handling = function() {
  if (this.c_index != undefined) {
    if (this.separate_outliers) {
      ...
      var nt = ds.numerical_transform(this.data, this.c_index);
      this.c_value = function (d) {
...
export function Matrix(id, dataset, records, cols_field, rows_field, vals_field) {
  View.call(this, id, dataset);
